 ...
 * @version $Id: $
 */
public class RemoveController extends Composite
{
    ...
    /** The overview table affected by the current remove operation. */
    ...
    /**
     * Creates a new instance of {@code RemoveController}.
     */
     ...
     *        <b>null</b>)
     * @param tab the affected overview table (must not be <b>null</b>)
     ...
     */
    public void performRemove(RemoveServiceHandler handler, OverviewTable tab,
    ...
    interface RemoveControllerUiBinder extends
            UiBinder<Widget, RemoveController>
    {
    }
