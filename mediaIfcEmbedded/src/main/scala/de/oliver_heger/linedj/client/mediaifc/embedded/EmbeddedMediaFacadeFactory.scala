...
import de.oliver_heger.linedj.client.mediaifc.actors.ActorBasedMediaFacadeFactory

/**
  * An implementation of
  * [[de.oliver_heger.linedj.client.mediaifc.MediaFacadeFactory]] that creates
