...
import de.oliver_heger.linedj.player.engine.radio.facade.ActorCreatorForEventManagerTests.{ActorCheckFunc, ClassicActorCheckFunc}
...
/**
  ...
  *
  * TODO: This module should be removed again after the player engine has been
  *       migrated to Scala 3 and can be used as a dependency.
  */
