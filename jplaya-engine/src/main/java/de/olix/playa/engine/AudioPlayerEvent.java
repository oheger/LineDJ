...
/**
 * <p>
 * An event class used by the <code>{@link AudioPlayer}</code> class.
 * </p>
 * <p>
 * This event class is used for reporting important status changes of an
 * <code>AudioPlayer</code> object. Listeners registered at an audio player
 * can inspect the event's properties to gather more information about the
 * player's current status. Depending on the event type not all of these
...
public class AudioPlayerEvent extends EventObject
{
    ...
    /**
     * Creates a new instance of <code>AudioPlayerEvent</code> and initializes
     * it.
     *
