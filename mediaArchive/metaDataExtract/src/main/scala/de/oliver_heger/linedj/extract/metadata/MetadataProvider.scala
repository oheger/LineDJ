...
/**
  * A value class representing the version of metadata that is managed by a
  * concrete [[MetadataProvider]]. This is currently just a numeric value. The
  * concrete meaning of this number depends on the type of metadata, e.g. ID3.
  *
  * @param value the version number
  */
case class MetadataVersion(value: Int) extends AnyVal
...
trait MetadataProvider:
  /**
    * Returns the version of metadata managed by this provider.
    *
    * @return the metadata version
    */
  def version: MetadataVersion
